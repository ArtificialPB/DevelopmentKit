...
import com.artificial.cachereader.wrappers.rt6.loaders.ObjectDefinitionLoader;
...
public class ObjectDefinition extends ProtocolWrapper implements Dynamic {
    ...
    public int approachableDirection = -1;
    ...
    //modelTypes.length == number of arrays in modelIds
    ...
    protected void decodeOpcode(final Stream data, final int opcode) {
        if (opcode == 1) {
            ...
            skipValue(opcode, approachableDirection = data.getUByte());
